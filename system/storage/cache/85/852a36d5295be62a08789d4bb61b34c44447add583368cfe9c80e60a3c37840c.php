...
/* OC3ethos/template/common/cart.twig */
class __TwigTemplate_1c64e02f82e259da1fd07bf3dee78ff9cf8750f6ab311121ad7109046c674269 extends Twig_Template
{
  ...
  <button type=\"button\" data-toggle=\"dropdown\" data-loading-text=\"";
        ...
        echo "\" class=\"btn btn-cart btn-block btn-md dropdown-toggle\"><i class=\"fa fa-shopping-cart\"></i> <span id=\"cart-total\">";
...
";
    ...
    {
        return "OC3ethos/template/common/cart.twig";
    }
...
/*   <button type="button" data-toggle="dropdown" data-loading-text="{{ text_loading }}" class="btn btn-cart btn-block btn-md dropdown-toggle"><i class="fa fa-shopping-cart"></i> <span id="cart-total">{{ text_items }}</span></button>*/
/*   <ul class="dropdown-menu pull-right">*/
